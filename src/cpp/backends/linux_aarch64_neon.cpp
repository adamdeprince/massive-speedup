...
namespace massive_speedup::backend_linux_aarch64_neon {
...
NB_MODULE(_neon, m) {
  massive_speedup::bindings::bind_backend_module<
      massive_speedup::backend_linux_aarch64_neon::Implementation>(
      m,
      massive_speedup::BackendKind::linux_aarch64_neon,
      "_Neon");
}
