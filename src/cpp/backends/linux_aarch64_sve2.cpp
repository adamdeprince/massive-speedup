...
namespace massive_speedup::backend_linux_aarch64_sve2 {
...
NB_MODULE(_sve2, m) {
  massive_speedup::bindings::bind_backend_module<
      massive_speedup::backend_linux_aarch64_sve2::Implementation>(
      m,
      massive_speedup::BackendKind::linux_aarch64_sve2,
      "_Sve2");
}
