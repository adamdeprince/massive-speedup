...
namespace massive_speedup::backend_linux_loongarch64_lasx {
...
NB_MODULE(_lasx, m) {
  massive_speedup::bindings::bind_backend_module<
      massive_speedup::backend_linux_loongarch64_lasx::Implementation>(
      m,
      massive_speedup::BackendKind::linux_loongarch64_lasx,
      "_Lasx");
}
