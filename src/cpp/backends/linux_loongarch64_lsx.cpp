...
namespace massive_speedup::backend_linux_loongarch64_lsx {
...
NB_MODULE(_lsx, m) {
  massive_speedup::bindings::bind_backend_module<
      massive_speedup::backend_linux_loongarch64_lsx::Implementation>(
      m,
      massive_speedup::BackendKind::linux_loongarch64_lsx,
      "_Lsx");
}
