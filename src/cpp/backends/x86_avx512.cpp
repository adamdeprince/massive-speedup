...
namespace massive_speedup::backend_x86_avx512 {
...
NB_MODULE(_avx512, m) {
  massive_speedup::bindings::bind_backend_module<massive_speedup::backend_x86_avx512::Implementation>(
      m,
      massive_speedup::BackendKind::x86_avx512,
      "_Avx512");
}
